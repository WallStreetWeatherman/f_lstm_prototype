...
def create_model(input_shape, optimizer='adam', lstm_units=50, dropout_rate=0.2):
    model = Sequential()
...
def main():
    ...
    # Define the model
    model = KerasRegressor(build_fn=lambda: create_model(input_shape=X_train.shape[1:]), verbose=0)
